...
ActiveRecord::Schema.define(version: 2020_12_30_180500) do
  ...
  create_table "spina_admin_mail_emails", force: :cascade do |t|
    t.string "type"
    ...
    t.string "bcc_addresses", default: [], null: false, array: true
    t.string "reply_to", default: [], null: false, array: true
    ...
    t.bigint "quoted_email_id"
    t.index ["quoted_email_id"], name: "index_spina_admin_mail_emails_on_quoted_email_id"
    t.index ["thread_id"], name: "index_spina_admin_mail_emails_on_thread_id"
  end

  create_table "spina_admin_mail_mailboxes", force: :cascade do |t|
  ...
  create_table "spina_admin_mail_mailboxes_threads", id: false, force: :cascade do |t|
    t.bigint "spina_admin_mail_mailbox_id", null: false
    t.bigint "spina_admin_mail_thread_id", null: false
    t.index ["spina_admin_mail_mailbox_id", "spina_admin_mail_thread_id"], name: "index_spina_mail_mailboxes_threads_on_mailbox_and_thread_ids"
    t.index ["spina_admin_mail_thread_id", "spina_admin_mail_mailbox_id"], name: "index_spina_mail_mailboxes_threads_on_thread_and_mailbox_ids"
  end

  create_table "spina_admin_mail_mailboxes_users", id: false, force: :cascade do |t|
    t.bigint "spina_user_id", null: false
    t.bigint "spina_admin_mail_mailbox_id", null: false
    t.index ["spina_admin_mail_mailbox_id", "spina_user_id"], name: "index_spina_users_mail_mailboxes_on_mailbox_and_user_ids"
    t.index ["spina_user_id", "spina_admin_mail_mailbox_id"], name: "index_spina_users_mail_mailboxes_on_user_and_mailbox_ids"
  end

  create_table "spina_admin_mail_threads", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  add_foreign_key "spina_admin_mail_emails", "spina_admin_mail_emails", column: "quoted_email_id", on_delete: :nullify
  add_foreign_key "spina_admin_mail_emails", "spina_admin_mail_threads", column: "thread_id", on_delete: :cascade
end
